                        ...
                        <div class="panel-body">
                            <table class="table table-hover">
                                ...
                                @foreach($donatur as $donatur)
                                    ...
                                    <td>
                                        <a href="/admin/{{$kegiatan->id}}/{{$donatur->id}}/updateStatus" class="btn btn-success btn-sm">Validasi</a>
                                        <a href="/admin/{{$kegiatan->id}}/{{$donatur->id}}/delete" class="btn btn-danger btn-sm">Abaikan</a>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
