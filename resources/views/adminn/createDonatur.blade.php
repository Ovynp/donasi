...
<div class="main">
    <div class="main-content">
        ...
        <div class="tab-content">
            ...
            <div class="row">
            <form action="/admin/{{$user->id}}/{{$kegiatan->id}}/store" method="POST" enctype="multipart/form-data">
                <div class="col-md-9">
                    <div class="panel">
                        <div class="panel-body">
                            {{ csrf_field() }}
                                <div class="form-group {{$errors->has('nama') ? 'has-error' : ''}}">
                                    ...
                                    <input name="status" type="hidden" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="2">
                                </div>
